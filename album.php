<?php 
	...
	$iduser=$_GET['id'];
	$idl=$_SESSION['login'];
	$sqlstatus=mysqli_query($koneksi,"SELECT id,ids,nama,tanggal,jam,isistatus,foto,fotof,tipe FROM user INNER JOIN status ON user.id=status.iduser WHERE id='$iduser'");
	...
	// $sqluseri=mysqli_query($koneksi,"SELECT * FROM status WHERE ids='$idl'");
	// $fett=mysqli_fetch_assoc($sqluseri);
	// var_dump($sqlstatus);
    ...
    <body>
            ...
            <nav class="grey center">
              <div class="nav-wrapper">
                <ul id="nav-mobile">
                  ...
                  <li class="aktif" style="width: 33%"><a href="album.php?id=<?=$feti['id']; ?>">Album</a></li>
    	...
    	<section class="statu">
        	<div class="container">
        		...
        		<div class="col s12 m8 offset-m2 l6 offset-l3" style="margin-top: 30px;">
			        <div class="card-panel grey lighten-5 z-depth-1">

			        	<?php foreach($sqlstatus as $tampil): ?>
			        	<!-- <?php if($tampil['fotof']=='kosong'){ $kosong=true;  }else{ ?> -->
        				<!-- <?php if($tampil['tipe']=='foto'): ?> -->

			          <!-- <div class="row valign-wrapper">
			            <div class="col ">
			              <a href="profil.php?id=<?=$tampil['id']; ?>"><img width="50" height="50" src="images/slider/<?=$tampil['foto'];?>" alt="" class="circle"></a> 
			            </div>
			            <div class="col">
			          ...
			          <!-- <div class="col s12 m8 offset-m2 l6 offset-l3"> -->
		        		<span><img class="materialboxed" src="images/album/<?=$tampil['fotof'];?>" width="100%" height="190"></span>
		        	
			        	<div class="aksi center">
			        	<span>
			        	<span style="padding: 7px; font-size: 15px;"><a href="">suka</a></span> 
			        	<span style="padding:7px; font-size: 15px;"><a href="komentar.php?id=<?=$tampil['ids']; ?>">komentar<!-- (<?php if($tampil['idstatus']==$idl){
		        			echo mysqli_num_rows($pilihstatus);
		        		}else{
		        			echo"0";
		        		}?>) --></a></span> 
		        		<?php if($tampil['id']==$idl): ?>
		        		<a href="update.php">hapus</a><br>
		        		<?php endif; ?>
		        		</spam>
			        	</div>
			        	<!-- </div> -->
			        	...
			        	<!-- <?php } ?> -->
			  			...
			  			<!-- <?php if(empty($fett['fotof'])){
			  				echo'kosong';
			  			} ?> -->
			  			<!-- <?php if(isset($kosong)): ?>
			  				<h4>Tidak ada Album foto</h4>
			  			<?php endif ?> -->
